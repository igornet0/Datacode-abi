...
/// Minor 8+: [`Value::Date`] for `DateTime<FixedOffset>` (secs, nanos, offset_secs).
/// Minor 9+: [`Value::Duration`] (signed wall-clock span: secs, nanos).
pub const DATACODE_ABI_VERSION: AbiVersion = AbiVersion { major: 1, minor: 9 };
